...
@zedob.tgbot.on(CallbackQuery(data=re.compile(r"^age_verification_true")))
...
@zedob.tgbot.on(CallbackQuery(data=re.compile(r"^age_verification_false")))
...
@zedob.tgbot.on(CallbackQuery(data=re.compile(r"^chg_of_decision_")))
