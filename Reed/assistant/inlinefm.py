...
from Reed.Config import Config
from Reed.core.decorators import check_owner
from Reed.helpers import humanbytes, progress
from Reed.helpers.utils import _zedutils
...
# BACK
@zedob.tgbot.on(CallbackQuery(pattern="fmback"))
@check_owner
...
# UP
@zedob.tgbot.on(CallbackQuery(pattern="fmup_(.*)"))
@check_owner
async def up(event):
...
# DOWN
@zedob.tgbot.on(CallbackQuery(pattern="fmdown_(.*)"))
@check_owner
...
# FORTH
@zedob.tgbot.on(CallbackQuery(pattern="fmforth_(.*)"))
@check_owner
...
# REMOVE
@zedob.tgbot.on(CallbackQuery(pattern="fmrem_(.*)"))
@check_owner
...
# SEND
@zedob.tgbot.on(CallbackQuery(pattern="fmsend"))
@check_owner
...
# CUT
@zedob.tgbot.on(CallbackQuery(pattern="fmcut_(.*)"))
@check_owner
async def cut(event):
...
# COPY
@zedob.tgbot.on(CallbackQuery(pattern="fmcopy_(.*)"))
@check_owner
...
# PASTE
@zedob.tgbot.on(CallbackQuery(pattern="fmpaste_(.*)"))
@check_owner
