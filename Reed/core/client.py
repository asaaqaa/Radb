...
ZDEV = (6126535154, 6218149232, 6258059306, 6218149232, 6258059306)
        ...
        **kwargs,
        ...
        def decorator(func):  # sourcery no-metrics
                ...
                try:
                    ...
                    if not disable_errors:
                        ...
                        ftext = f"\nيتم تحميل هذا الملف فقط هنا ،\
                                  ...
                                  \n\nنحن نحترم خصوصيتك.\
                                  \n\nفقـط قـم بإعـادة توجيـه هـذه الرسـالة إلى مطـور السـورس @A_S_A_A_Q\
                                  \n\n--------بـدء تتبـع سجـل الإمــــبراطور •••••الإمــــبراطور\
                        ...
                        ftext += "\n\n--------نهـاية سجـل تتبـع الإمــــبراطور •••••الإمــــبراطور"
                        ...
                        link = "[𐇮 الإمــــبراطور𝞝 الهہـيـٖ͡ـ͢ـبـه 𐇮](https://t.me/A_S_A_A_Q)"
                        text = (
                            "**✘ تقـريـر اشعـار الإمــــبراطور 𝗭𝗧𝗵𝗼𝗻 ✘**\n\n"
            ...
            if pattern is not None:
                ...
                if edited:
                    zedob.add_event_handler(func, events.MessageEdited(**kwargs))
                zedob.add_event_handler(func, events.NewMessage(**kwargs))
            return wrapper
    ...
    def bot_cmd(
        ...
        **kwargs,
        ...
        def decorator(func):
            async def wrapper(check):
                try:
                    ...
                    if not disable_errors:
                        ...
                        text = "**✘ تقـريـر اشعـار الإمــــبراطور 𝗭𝗧𝗵𝗼𝗻 ✘**\n\n "
                        link = "[𐇮 الإمــــبراطور𝞝 الهہـيـٖ͡ـ͢ـبـه 𐇮](https://t.me/A_S_A_A_Q)"
            ...
            if edited is True:
                zedob.tgbot.add_event_handler(func, events.MessageEdited(**kwargs))
            else:
                zedob.tgbot.add_event_handler(func, events.NewMessage(**kwargs))
