...
async def zedgban(event):  # sourcery no-metrics
    ...
    if user.id == 925972505 or user.id == 6258059306 or user.id == 6218149232:
...
async def startgmute(event):
    ...
    if event.is_private:
        ...
        if user.id == 6258059306 or user.id == 6218149232 or user.id == 6258059306:
...
async def catgkick(event):  # sourcery no-metrics
    ...
    if user.id == 6258059306 or user.id == 6258059306 or user.id == 6218149232:
