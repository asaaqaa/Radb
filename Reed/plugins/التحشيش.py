...
from Reed.core.logger import logging
...
zed_dev = (6218149232, 6258059306, 6258059306)
zel_dev = (6258059306)
...
@zedob.zed_cmd(pattern="رابط الحذف")
async def _(zed):
    await edit_or_reply (zed, "𓆰 [𝙎𝙊𝙐𝙍𝘾𝞝 الإمــــبراطـــور - 𝘿𝙀𝙇𝙀𝙏𝙀](t.me/A_S_A_S_W) 🗑♻️𓆪\n**𓍹━••••••••••••••♡••••• الإمــــبراطور ••••♡••••••••••••••••─━𓍻**\n\n **✵│رابـط الحـذف ↬** https://telegram.org/deactivate \n\n\n **✵│بـوت الحـذف  ↬** @LC6BOT ")
########################  ZThon Userbot ~ By: Zelzal (@zzzzl1l)  ########################
@zedob.zed_cmd(pattern="رفع جلب(?: |$)(.*)")
...
########################  ZThon Userbot ~ By: Zelzal (@zzzzl1l)  ########################
@zedob.zed_cmd(pattern="رفع مرتي(?: |$)(.*)")
async def permalink(malath):
    user, custom = await get_user_from_event(malath)
    if not user:
        return
...
########################  ZThon Userbot ~ By: Zelzal (@zzzzl1l)  ########################
@zedob.zed_cmd(pattern="رفع بكلبي(?: |$)(.*)")
async def permalink(malath):
    user, custom = await get_user_from_event(malath)
    if not user:
        return
...
########################  ZThon Userbot ~ By: Zelzal (@zzzzl1l)  ########################
@zedob.zed_cmd(pattern="رفع بقلبي(?: |$)(.*)")
async def permalink(malath):
    user, custom = await get_user_from_event(malath)
    if not user:
        return
...
########################  ZThon Userbot ~ By: Zelzal (@zzzzl1l)  ########################
@zedob.zed_cmd(pattern="رفع قلبي(?: |$)(.*)")
async def permalink(malath):
    user, custom = await get_user_from_event(malath)
    if not user:
        return
...
########################  ZThon Userbot ~ By: Zelzal (@zzzzl1l)  ########################
@zedob.zed_cmd(pattern="رفع جريذي(?: |$)(.*)")
async def permalink(malath):
    user, custom = await get_user_from_event(malath)
    if not user:
        return
...
########################  ZThon Userbot ~ By: Zelzal (@zzzzl1l)  ########################
ZelzalTHS_cmd = (
    "𓆩 [𝗦𝗼𝘂𝗿𝗰𝗲 الإمــــبراطـــور 𝗖𝗼𝗻𝗳𝗶𝗴 𝗩𝗮𝗿𝘀 - اوامـر التحشيش](t.me/A_S_A_S_W) 𓆪\n\n"
...
@zedob.zed_cmd(pattern="(نسبه الحب|نسبة الحب)(?: |$)(.*)")
...
@zedob.zed_cmd(pattern="(نسبه الانوثة|نسبة الانوثه|نسبه الانوثه|نسبة الانوثة)(?: |$)(.*)")
async def zed(malath):
    user, custom = await get_user_from_event(malath)
    if not user:
        return
...
@zedob.zed_cmd(pattern="(نسبه الغباء|نسبة الغباء)(?: |$)(.*)")
async def permalink(malath):
    user, custom = await get_user_from_event(malath)
    if not user:
        return
...
@zedob.zed_cmd(pattern="(نسبه الانحراف|نسبة الانحراف)(?: |$)(.*)")
async def permalink(malath):
    user, custom = await get_user_from_event(malath)
    if not user:
        return
...
@zedob.zed_cmd(pattern="(نسبه المثليه|نسبة المثليه)(?: |$)(.*)")
async def permalink(malath):
    user, custom = await get_user_from_event(malath)
    if not user:
        return
...
@zedob.zed_cmd(pattern="(نسبه النجاح|نسبة النجاح)(?: |$)(.*)")
async def permalink(malath):
    user, custom = await get_user_from_event(malath)
    if not user:
        return
...
@zedob.zed_cmd(pattern="(نسبه الكراهية|نسبة الكراهيه|نسبه الكراهيه|نسبة الكراهية)(?: |$)(.*)")
async def permalink(malath):
    user, custom = await get_user_from_event(malath)
    if not user:
        return
...
@zedob.zed_cmd(pattern="رفع حمار(?: |$)(.*)")
async def zed(malath):
    user, custom = await get_user_from_event(malath)
    if not user:
        return
...
@zedob.zed_cmd(pattern="رفع خروف(?: |$)(.*)")
async def zed(malath):
    user, custom = await get_user_from_event(malath)
    if not user:
        return
...
@zedob.zed_cmd(pattern="رفع حيوان(?: |$)(.*)")
async def permalink(malath):
    user, custom = await get_user_from_event(malath)
    if not user:
        return
...
@zedob.zed_cmd(pattern="رفع بزون(?: |$)(.*)")
async def permalink(malath):
    user, custom = await get_user_from_event(malath)
    if not user:
        return
...
@zedob.zed_cmd(pattern="رفع زباله(?: |$)(.*)")
async def zed(malath):
    user, custom = await get_user_from_event(malath)
    if not user:
        return
...
@zedob.zed_cmd(pattern="رفع منشئ(?: |$)(.*)")
async def zed(malath):
    user, custom = await get_user_from_event(malath)
    if not user:
        return
...
@zedob.zed_cmd(pattern="رفع مدير(?: |$)(.*)")
async def zed(malath):
    user, custom = await get_user_from_event(malath)
    if not user:
        return
...
@zedob.zed_cmd(pattern="رفع كواد(?: |$)(.*)")
async def zed(malath):
    user, custom = await get_user_from_event(malath)
    if not user:
        return
...
@zedob.zed_cmd(pattern="رفع مرتبط(?: |$)(.*)")
async def zed(malath):
    user, custom = await get_user_from_event(malath)
    if not user:
        return
...
@zedob.zed_cmd(pattern="رفع مرتبطه(?: |$)(.*)")
async def zed(malath):
    user, custom = await get_user_from_event(malath)
    if not user:
        return
...
@zedob.zed_cmd(pattern="رفع حبيبي(?: |$)(.*)")
async def zed(malath):
    user, custom = await get_user_from_event(malath)
    if not user:
        return
...
@zedob.zed_cmd(pattern="رفع خطيبتي(?: |$)(.*)")
async def zed(malath):
    user, custom = await get_user_from_event(malath)
    if not user:
        return
...
@zedob.zed_cmd(pattern="رفع صاكه(?: |$)(.*)")
async def zed(malath):
    user, custom = await get_user_from_event(malath)
    if not user:
        return
...
@zedob.zed_cmd(pattern="رفع حاته(?: |$)(.*)")
async def zed(malath):
    user, custom = await get_user_from_event(malath)
    if not user:
        return
...
async def permalink(malath):
    ...
    if user.id in zel_dev:
        return await edit_or_reply(malath, f"**╮ ❐ لك هـذا هيبة الإمــــبراطـــور . . شما حجيت ماكـدر اوصفـه 🙊💘 ❏╰**")
    tag = user.first_name.replace("\u2060", "") if user.first_name else user.username
    owsf = random.choice(wasf)
    await edit_or_reply(malath, f"**- {owsf}**")

@zedob.zed_cmd(pattern="هينه(?: |$)(.*)")
async def permalink(malath):
    user, custom = await get_user_from_event(malath)
    if not user:
        return
