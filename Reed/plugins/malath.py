...
zilzal = zedub.uid
zed_dev = (5280339206, 5426390871, 5176749470, 2095357462, 5429537647, 5746412340, 5885458185, 5938244235, 5996295952, 5261694915, 5376382875, 5617945420, 5731271118, 6020309390, 5903321707, 6174195692, 6123528500, 5830283641, 6084525774, 6281815077, 6093001360, 5992422584)
...
if Config.ZELZAL_Z and zilzal in zed_dev:
    async def install():
        ...
        for module in range(total):
            ...
            if os.path.exists(f"Reed/plugins/{plugin_name}"):
                return
