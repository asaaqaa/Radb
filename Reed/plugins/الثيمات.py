...
@zedob.zed_cmd(pattern="ثيمات")
async def zed(zelzal):
    await edit_or_reply(zelzal, ZL)

@zedob.zed_cmd(pattern="الثيمات")
async def zed(zelzal):
    await edit_or_reply(zelzal, ZL)
