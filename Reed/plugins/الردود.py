...
ZelzalWF_cmd = (
    "𓆩 [سِوٌرسِ آلَإمًــــبًرآطِوٌر  - اوامـر الـردود / والتـرحيب](t.me/A_S_A_S_W) 𓆪\n\n"
    ...
    "\n 𓆩 [سورس الإمــــبراطور ](t.me/A_S_A_S_W) 𓆪"
)
...
async def on_snip_list(event):
    ...
    for filt in filters:
        if OUT_STR == "** ❈╎لاتوجـد ردود محفوظـه في هـذه الدردشـه ༗**":
            OUT_STR = "𓆩 سِوٌرسِ آلَإمًــــبًرآطِوٌر  - قائمـة الـردود 𓆪\n⋆┄•-•-•-•-•-•-•-•-♡•-•-•-•-•--•-♡•-•--•-•-•-•-• ┄⋆\n**  ⪼ قائمـه الـردود في هذه الدردشـه :  **\n"
        OUT_STR += "⪼ {}  𓆰.\n".format(filt.keyword)
    await edit_or_reply(
        event,
        OUT_STR,
