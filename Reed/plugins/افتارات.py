...
async def _(event):
    ...
    try:
        ...
        await zzevent.edit("**╮•⎚ معــذرةًًً .. لـم استطـع ايجـاد المطلـوب ☹️💔**")


@zedob.zed_cmd(pattern="ستوري انمي$")
async def _(event):
...
@zedob.zed_cmd(pattern="ولد انمي$")
async def _(event):
...
@zedob.zed_cmd(pattern="بنت انمي$")
async def _(event):
    zzevent = await edit_or_reply(event, "**╮ - جـارِ تحميـل الآفتـار ...𓅫╰**")
    try:
        zedph = [
